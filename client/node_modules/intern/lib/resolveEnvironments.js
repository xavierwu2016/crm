(function (factory) {
    ...
    function resolveEnvironments(capabilities, environments, available) {
        ...
        return createPermutations({}, expandedEnvironments).map(function (environment) { return new Environment_1.default(environment); });
    }
    ...
    function normalizeVersion(env) {
        var browserVersion = env.browserVersion || env.version;
        return tslib_1.__assign({}, env, { browserVersion: browserVersion, version: browserVersion });
    }
    ...
    function getVersions(environment, available) {
        ...
        available
            ...
            return !Object.keys(environment)
                .filter(function (key) {
                return key !== 'browserVersion' && key !== 'version' && key !== 'browser';
            })
                ...
                if (key === 'browserName' && value === 'MicrosoftEdge') {
                    return (availableEnvironment[key] !== 'MicrosoftEdge' ||
        ...
        return environments.map(function (env) {
            if (env.browserName === 'MicrosoftEdge') {
                if (available.some(function (ae) { return ae.browserName === 'edge'; })) {
                    return tslib_1.__assign({}, env, { browserName: 'edge', browser: 'edge' });
                }
            }
            return env;
        });
