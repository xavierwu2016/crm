...
var webdrivers_json_1 = require("./webdrivers.json");
var SeleniumTunnel = (function (_super) {
    ...
    function SeleniumTunnel(options) {
        var _this = _super.call(this, Object.assign({
            seleniumArgs: [],
            drivers: ['chrome'],
            baseUrl: webdrivers_json_1.drivers.selenium.baseUrl,
            version: webdrivers_json_1.drivers.selenium.latest,
...
var ChromeConfig = (function (_super) {
    ...
    function ChromeConfig(options) {
        return _super.call(this, Object.assign({
            arch: process.arch,
            baseUrl: webdrivers_json_1.drivers.chrome.baseUrl,
            platform: process.platform,
            version: webdrivers_json_1.drivers.chrome.latest
        }, options)) || this;
    }
...
var FirefoxConfig = (function (_super) {
    ...
    function FirefoxConfig(options) {
        return _super.call(this, Object.assign({
            arch: process.arch,
            baseUrl: webdrivers_json_1.drivers.firefox.baseUrl,
            platform: process.platform,
            version: webdrivers_json_1.drivers.firefox.latest
        }, options)) || this;
    }
...
var IEConfig = (function (_super) {
    ...
    function IEConfig(options) {
        return _super.call(this, Object.assign({
            arch: process.arch,
            baseUrl: webdrivers_json_1.drivers.ie.baseUrl,
            version: webdrivers_json_1.drivers.ie.latest
        }, options)) || this;
    }
...
var EdgeConfig = (function (_super) {
    ...
    function EdgeConfig(options) {
        return _super.call(this, Object.assign({
            arch: process.arch,
            baseUrl: webdrivers_json_1.drivers.edge.baseUrl,
            version: webdrivers_json_1.drivers.edge.latest,
            versions: webdrivers_json_1.drivers.edge.versions
        }, options)) || this;
    }
    ...
    Object.defineProperty(EdgeConfig.prototype, "url", {
        get: function () {
            ...
            var urlOrObj = webdrivers_json_1.drivers.edge.versions[this.version].url;
...
var EdgeChromiumConfig = (function (_super) {
    ...
    function EdgeChromiumConfig(options) {
        return _super.call(this, Object.assign({
            arch: process.arch,
            baseUrl: webdrivers_json_1.drivers.edgeChromium.baseUrl,
            platform: process.platform,
            version: webdrivers_json_1.drivers.edgeChromium.latest
        }, options)) || this;
    }
